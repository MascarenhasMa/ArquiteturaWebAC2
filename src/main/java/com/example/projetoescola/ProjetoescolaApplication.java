...
public class ProjetoescolaApplication {
    ...
    public CommandLineRunner init(
        ...
        return args -> {
            ...
            Setor setor3 = new Setor(null, "Segurança", new ArrayList<>());
            setorRepository.save(setor1);
            setorRepository.save(setor2);
            setorRepository.save(setor3);

            // Criação de Funcionários
            Funcionario funcionario1 = funcionarioRepository.save(new Funcionario(null, "Jose", setor1, new ArrayList<>()));
            Funcionario funcionario2 = funcionarioRepository.save(new Funcionario(null, "Maria", setor1, new ArrayList<>()));
            Funcionario funcionario3 = funcionarioRepository.save(new Funcionario(null, "Eduardo", setor2, new ArrayList<>()));
            Funcionario funcionario4 = funcionarioRepository.save(new Funcionario(null, "Marcelo", setor2, new ArrayList<>()));
            Funcionario funcionario5 = funcionarioRepository.save(new Funcionario(null, "Caio", setor3, new ArrayList<>()));
